...
TC_IL_004 - Verify logging interaction with missing required fields
    [Documentation]  FR4.1 Verify logging interaction with missing required fields
    ...
    Input Text  xpath=//textarea[@placeholder="Write down what was said"]  Empty date.

    Wait Until Page Contains Element  css=.vdp-datepicker__clear-button
    Click Element  css=.vdp-datepicker__clear-button

    Click Button  css=button[cy-name="save-call-button"]
    Wait Until Page Does Not Contain  Empty date.  timeout=10s
