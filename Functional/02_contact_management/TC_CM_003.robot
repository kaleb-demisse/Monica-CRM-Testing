...
TC_CM_003 - Verify viewing the list of all contacts
    [Documentation]  FR2.2 Verify viewing the list of all contacts
    ...
    Wait Until Element Is Visible   css=.list    15s
