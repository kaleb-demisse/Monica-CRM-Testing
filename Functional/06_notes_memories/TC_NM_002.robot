...
TC_NM_002 - Verify successful recording of a significant life event for a contact
    [Documentation]  FR6.2 Verify successful recording of a significant life event for a contact
    ...
    Click Element    xpath=//span[contains(text(),'Life events')]
    Wait Until Element Is Visible    xpath=//a[contains(text(),'Add life event')]    10s
    Click Element    xpath=//a[contains(text(),'Add life event')]
    Wait Until Element Is Visible    xpath=//li[contains(., 'Work & education')]    10s
    Click Element    xpath=//li[contains(., 'Work & education')]
    Wait Until Element Is Visible    xpath=//li[contains(., 'Started a new job')]    10s
    Click Element    xpath=//li[contains(., 'Started a new job')]
    Wait Until Element Is Visible    xpath=//select[@name='year']    10s
    Click Button    xpath=//button[contains(text(), 'Add')]
    Wait Until Page Contains    Started a new job    15s
