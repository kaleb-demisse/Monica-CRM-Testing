...
TC_J_004 - Verify successful deletion of a journal entry
    [Documentation]  FR7.1 Verify successful deletion of a journal entry
    [Tags]  Journaling
    ...
    Wait Until Element Is Visible    xpath=//a[contains(@cy-name,'entry-delete-button')]    15s

    Click Element    xpath=(//a[contains(@cy-name,'entry-delete-button')])[1]

    Sleep    2s
    Wait Until Page Does Not Contain    Updated productive day
